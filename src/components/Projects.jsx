...
import tunikafon from "../Assets/projects/Tunikafon.png"
...
function Projects() {
  ...
  const [listProjects] = useState([
    ...
    },
    {
      name: 'Tunikafon',
      type: 'game',
      des: "Created to calculate the cost and size of a modern ceiling",
      mission: 'Solving problems in computing',
      language: 'Vite + React.js, TypeScript, Tailwind CSS',
      images: tunikafon,
      link: 'https://ustaabdulloh777.uz/',
      github: 'https://github.com/abdulazizsaidovcode/tunikafon-react'
    },
  ]);
      ...
      <div className='w-full generall__border py-5'>
        <div className='w-max generall__border mx-auto py-5'>
          ...
          <div className=" text-center max-w-[500px] m-auto flex justify-center items-end" >
            <p data-cursor-style className='px-3'>About my projects (These are not all.)</p>
          </div>
                ...
                <div className='generall__border p-4'>
                  ...
                  <div className=" mt-10">
                    ...
                    <div className='flex gap-3 flex-wrap md:justify-start justify-center w-full'>
                      <Btnfirst text='github' link='https://github.com/Abdulvohid31' />
